...
if(la === 1) {
    ptxaligner(args[0], options.perf !== undefined, options.verbose !== undefined);
} else if(options.config && options.config.length > 0) {
    options.config.forEach(path => {
        ptxaligner(path, options.perf !== undefined, options.verbose !== undefined);
    });
}